...
def ebay_plot(query, msrp, df, extra_title_text=''):
    ...
    if slope >= 0:
        ax3.plot(df['Sold Date'], mymodel, dashes=[4, 1], label='Linear Trend Line')
    elif msrp > 0:
        ax3.plot(df['Sold Date'], mymodel, dashes=[4, 1], label='Linear Trend Line - Est MSRP Date - ' + str(est_msrp))
